...
public class HttpTaskHandler {
    ...
    /**
     * V530这里内存泄露了 再onDestory的时候把这个置空
     * @return
     */
    public static Map<String, List<OkHttpTask>> getHttpTaskMap() {
        return httpTaskMap;
    }
    
    public static void setHttpTaskMap(Map<String, List<OkHttpTask>> httpTaskMap) {
        HttpTaskHandler.httpTaskMap = httpTaskMap;
    }
